Feature: hashtags
 ...
 Scenario: a new project is created with 3 hashtags
     Given a new project valid project with hashtags "new,project,art"
     When hashtags are listed
     Then get a list of 3 hashtags

 Scenario: two projects with similar hashtags
     Given a new project valid project with hashtags "green,world"
     And a new project valid project with hashtags "green,now"
